package com.mirea.kuznetsova.notificationapp;
...
public class MainActivity extends AppCompatActivity {
    private static final String CHANNEL_ID = "com.mirea.kuznetsova.notificationapp.ANDROID";
    ...
    public void onClickNewMessageNotification(View view){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentText("Notification text for MIREA") .setWhen(System.currentTimeMillis())
